...
services:
  ...
  items:
    - id: fullstack-web
      ...
      deliverables: [Responsive, mobile-first design implementation, Fast server-side rendering or static site generation, API integrations & custom backend endpoints, SEO & accessibility optimization]
    ...
    - id: mentorship-1on1
      ...
      deliverables: [Live 60-minute video sessions with real-time pair programming, Customized learning plan and weekly homework tasks, Asynchronous code reviews between calls, Career advice and resume/portfolio guidance]
      pricing: Starting at $45 / hour (Discounts for multi-session packages)
      popular: true
    - id: api-architecture
      category: Development
      ...
      deliverables: [RESTful / GraphQL API engineering, Database design (PostgreSQL, SQLite, MongoDB), Authentication & Security audits, Cloud deployment & Docker setups]
    ...
    - id: code-audit
      ...
      deliverables: [Performance & Lighthouse audit report, Dependency upgrades & security patches, Refactoring roadmap & PR execution, CI/CD workflow configuration]
    ...
    - id: custom-workshops
      ...
      deliverables: [Curriculum slides, repository templates, and exercise material, Interactive Q&A and group project code reviews, Recorded video sessions for future reference, Post-workshop reference guides]
    ...
    - id: code-reviews
      ...
      deliverables: [Video walkthrough explaining suggested improvements, Detailed GitHub pull request comments, Refactored code examples]
